...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() {Id="1", Email="sanjeev.pc2011@gmail.com", ZipCode = "33720" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("sanjeev.pc2011@gmail.com", "Forms"), null);
